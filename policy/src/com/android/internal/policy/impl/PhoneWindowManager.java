...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    private static final int KEY_ACTION_QUICKMEMO = 10;
    ...
    private void readConfigurationDependentBehaviors() {
        mLongPressOnHomeBehavior = getStr(mContext.getResources().getInteger(
                com.android.internal.R.integer.config_longPressOnHomeBehavior));
        if (Integer.parseInt(mLongPressOnHomeBehavior) < KEY_ACTION_NOTHING ||
                Integer.parseInt(mLongPressOnHomeBehavior) > KEY_ACTION_IN_APP_SEARCH) {
        ...
        synchronized (mLock) {
            ...
            if (!keyRebindingEnabled) {
                ...
                if (mHasHomeKey) {
                    ...
                    mHasMenuKeyEnabled = (mLongPressOnHomeBehavior.equals(getStr(KEY_ACTION_MENU)));
                }
                if (mHasBackKey) {
                ...
                if (mHasMenuKey) {
                    ...
                    mHasMenuKeyEnabled |= (mPressOnMenuBehavior.equals(getStr(KEY_ACTION_MENU))) ||
                        (mLongPressOnMenuBehavior.equals(getStr(KEY_ACTION_MENU)));
                }
                if (mHasAssistKey) {
                    ...
                    mHasMenuKeyEnabled |= (mPressOnAssistBehavior.equals(getStr(KEY_ACTION_MENU))) ||
                        (mLongPressOnAssistBehavior.equals(getStr(KEY_ACTION_MENU)));
                }
                if (mHasAppSwitchKey) {
                    ...
                    mHasMenuKeyEnabled |= (mPressOnAppSwitchBehavior.equals(getStr(KEY_ACTION_MENU))) ||
                        (mLongPressOnAppSwitchBehavior.equals(getStr(KEY_ACTION_MENU)));
                }
            }
    ...
    public long interceptKeyBeforeDispatching(WindowState win, KeyEvent event, int policyFlags) {
        ...
        // timeout.
        if (keyCode == KeyEvent.KEYCODE_HOME) { //do not touch the home implementation /t
            ...
            if (repeatCount == 0) {
                ...
                if (mHomeDoubleTapPending) {
                    ...
                    mHomeConsumed = true;
                    performKeyAction(getStr(mDoubleTapOnHomeBehavior));
            ...
            if ((fl & (FLAG_LAYOUT_IN_SCREEN | FLAG_LAYOUT_INSET_DECOR))
                ...
                if (attrs.type == TYPE_STATUS_BAR_PANEL) {
                    ...
                    if (adjust != SOFT_INPUT_ADJUST_RESIZE) {
                        ...
                        df.right = of.right = cf.right = mRestrictedScreenLeft;
                        df.bottom = of.bottom = cf.bottom = mRestrictedScreenTop;
                    }
                    if (adjust != SOFT_INPUT_ADJUST_NOTHING) {
