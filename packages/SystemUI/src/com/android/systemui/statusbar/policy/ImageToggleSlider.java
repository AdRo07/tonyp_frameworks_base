...
public class ImageToggleSlider extends RelativeLayout 
    ...
    public interface Listener {
        ...
        public void onChanged(ImageToggleSlider v, boolean tracking, boolean checked, int value);
    }
    ...
    public ImageToggleSlider(Context context) {
        this(context, null);
    }

    public ImageToggleSlider(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ImageToggleSlider(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        View.inflate(context, R.layout.status_bar_image_toggle_slider, this);
    ...
    public void setImage(int id) {
        mImage.setBackgroundResource(id);
    }
}
